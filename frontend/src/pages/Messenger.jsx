    ...
    return (
        ...
        <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', background: colors.bgApp }}>
            ...
            <div style={{ flex: 1, display: mobileView === 'list' && isMobile ? 'none' : 'flex', flexDirection: 'column', minWidth: 0 }}>
                <ChatWindow key={activeChat?._id} chat={activeChat} socket={socket} online={online} incomingMsg={incomingMsg} incomingReaction={incomingReaction} clearedChatId={clearedChatId} allChats={chats} onNewChat={handleNewChat} onBack={handleBack} onRemoveChat={handleRemoveChat} />
            </div>
        </div>
    );
}
